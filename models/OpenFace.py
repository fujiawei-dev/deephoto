'''
Date: 2021-01-12 17:31:04
LastEditors: Rustle Karl
LastEditTime: 2021-01-12 19:09:37
'''
...
def OpenFaceModel():
    _input = Input(shape=(96, 96, 3))

    x = ZeroPadding2D(padding=(3, 3), input_shape=(96, 96, 3))(_input)
    ...
    # Final Model
    return Model(inputs=[_input], outputs=norm_layer)
